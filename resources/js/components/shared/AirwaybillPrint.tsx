...
function buildPrintHtml(
    ...
    const senderSignatureBlock = `<div style="border-top:1px solid #ddd;padding:8px 10px 10px;min-height:56px;display:flex;flex-direction:column;justify-content:flex-end;gap:6px">
            <div style="font-size:8px;font-weight:700;color:${TEAL_DARK};text-transform:uppercase">Sender Signature</div>
            <div style="border-bottom:1px solid #888;min-height:16px"></div>
...
<div class="awb">
  ...
  <div style="display:grid;grid-template-columns:1.5fr 1.15fr 0.75fr;border-bottom:2px solid ${TEAL}">
    <!-- Company info -->
        <div style="padding:10px 12px;font-size:9px;line-height:1.45;border-right:1px solid #aaa;background:#f9f9f9;display:flex;flex-direction:column;justify-content:center;gap:3px">
            <strong style="font-size:11px;color:#111;display:block;margin-bottom:2px">${companyName}</strong>
            <span style="color:#555">${AWB_ADDRESS_LINE}</span>
            <span style="color:#555">Phone Operations: ${AWB_PHONE_OPS}</span>
            <span style="color:#555">HQ: ${AWB_PHONE_HQ}</span>
    ...
    <div style="padding:8px 12px;background:${TEAL};-webkit-print-color-adjust:exact;print-color-adjust:exact;display:flex;flex-direction:column;justify-content:space-between;align-items:center;text-align:center;gap:6px">
      <div style="display:flex;align-items:center;justify-content:center;flex:1;width:100%">
        <img src="${origin}${LOGO_URL}" alt="${companyName}" style="height:54px;max-width:95%;object-fit:contain" onerror="this.style.display='none';document.getElementById('fallback-name').style.display='block'"/>
        <div id="fallback-name" style="display:none;font-size:20px;font-weight:900;color:#fff;letter-spacing:1px">${companyName}</div>
      </div>
      <div style="width:100%;border-top:1px solid rgba(255,255,255,.35);padding-top:6px;line-height:1.25">
        <div style="font-size:11px;font-weight:700;color:#fff">www.rtexpress.co.tz</div>
        <div style="font-size:10px;color:rgba(255,255,255,.95)">info@rtexpress.co.tz</div>
      </div>
    </div>
  </div>
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;border-bottom:1px solid #aaa">
    ${["Received by RT Express", "Received by Consignee"]
        .map(
            (title, bi) =>
...
/* ─── Main component ──────────────────────────────────────────────────────── */
export default function AirwaybillPrint({
    shipment,
    companyName,
    companyAddress = "",
    companyPhone = "",
    ...
    const handlePrint = () => {
        ...
        const w = window.open(
            "",
            "_blank",
            "width=860,height=740,scrollbars=yes",
        );
        if (!w) {
            alert("Please allow pop-ups to print the airwaybill.");
            return;
        }
                ...
                >
                    ...
                    >
                        ...
                        <div
                            style={{
                                display: "grid",
                                gridTemplateColumns: "1.5fr 1.15fr 0.75fr",
                        ...
                        >
                            ...
                            >
                                ...
                                <div style={{ color: "#555" }}>
                                    Phone Operations: {AWB_PHONE_OPS}
                                </div>
                                <div style={{ color: "#555" }}>
                                    HQ: {AWB_PHONE_HQ}
                                </div>
                        ...
                        >
                            ...
                            >
                                RT Express terms and conditions strictly apply,
