...
export default function Topbar({ onNewShipment }: TopbarProps) {
  ...
  return (
    <header className="topbar">
      <button className="icon-btn" onClick={toggleSidebar} data-tip="Toggle sidebar">
      ...
      <span className="topbar-title">{PAGE_TITLES[activePage] ?? activePage}</span>
      <div className="topbar-actions">
        ...
        <button className="icon-btn" onClick={toggleTheme} data-tip={THEME_LABELS[theme]}>
          {theme === 'dark' && (
        ...
        <button className="icon-btn" data-tip="Notifications" style={{ position: 'relative' }}>
          <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round">
            <path d="M8 1a5 5 0 015 5v3l1.5 2H1.5L3 9V6a5 5 0 015-5z"/>
            <path d="M6.5 13a1.5 1.5 0 003 0"/>
          </svg>
          <span style={{ position: 'absolute', top: 6, right: 6, width: 7, height: 7, borderRadius: '50%', background: 'var(--red)', border: '1.5px solid var(--bg-2)' }}/>
        </button>
