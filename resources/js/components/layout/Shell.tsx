  ...
  return (
    <div className="shell">
      ...
      <div className="main">
        ...
        <div className={`page${activePage === 'fleet' ? ' active' : ''}`}>
          <Fleet />
        </div>
        <div className={`page${activePage === 'routes' ? ' active' : ''}`}>
          <Routes />
        </div>
        <div className={`page${activePage === 'warehouses' ? ' active' : ''}`}>
          <Warehouses />
        </div>
        <div className={`page${activePage === 'customers' ? ' active' : ''}`}>
          <Customers />
        </div>
        <div className={`page${activePage === 'billing' ? ' active' : ''}`}>
          <Billing />
        </div>
        ...
        <div className={`page${activePage === 'placeholder' ? ' active' : ''}`}>
          <Placeholder />
        </div>
      </div>
