...
const THEMES: { value: Theme; label: string; desc: string }[] = [
    ...
    {
        value: "rtexpress",
        label: "RT Express Dark",
        desc: "Navy & red brand theme",
    },
    {
        value: "rtexpress-light",
        label: "RT Express Light",
        ...
        },
        {
            ...
            icon: (
                <svg
                    ...
                    strokeLinecap="round"
                >
                    <path d="M8 1L2 4v5c0 3.5 2.7 6 6 7 3.3-1 6-3.5 6-7V4L8 1z" />
                </svg>
            ),
        },
    ];
                        ...
                        <>
                            ...
                            >
                                ...
                                <div className="form-group">
                                    ...
                                    <input
                                        className="sh-input"
                                        value={company.awbPrefix}
                                        maxLength={8}
                                        placeholder="e.g. 0255"
                                        onChange={(e) =>
                                            setCompany((c) => ({
                                                ...c,
                                                awbPrefix: e.target.value,
                                            }))
                                        }
                                    />
                                    <div
                                    ...
                                    >
                                        AWB numbers will be generated as:{" "}
                                        <strong>
                                            {company.awbPrefix || "0255"}
                                            00000001
                                        </strong>
                                    </div>
                                </div>
                                ...
                                {THEMES.map((t) => (
                                    <button
                                        ...
                                        style={{
                                            padding: "14px 16px",
                                            borderRadius: 10,
                                            border: `2px solid ${theme === t.value ? "var(--blue)" : "var(--border-strong)"}`,
                                            background:
                                                theme === t.value
                                                    ? "var(--blue-dim)"
                                                    : "var(--bg-3)",
                            ...
                            {[
                                {
                                    ...
                                    desc: "Get notified when shipment status changes",
                                },
                                {
                                    key: "emailBooking",
                                    label: "New Booking Requests",
                                    desc: "Alert when new booking arrives",
                                },
                                {
                                    key: "emailInvoice",
                                    label: "Invoice Reminders",
                                    desc: "Reminders for pending and overdue invoices",
                                },
                                {
                                    key: "desktopAlerts",
                                    label: "Desktop Notifications",
                                    desc: "Show browser desktop notifications",
                                },
                                {
                                    key: "overdueReminder",
                                    label: "Overdue Shipment Alerts",
                                    desc: "Alert when shipments pass their ETA",
                                },
                                {
                                    key: "weeklyReport",
                                    label: "Weekly Summary Report",
                                    desc: "Receive a weekly performance digest",
                                },
                            ].map((item) => (
                                <div
                                    key={item.key}
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        style={{
                                            ...
                                            flexShrink: 0,
                                            background: notif[
                                                item.key as keyof typeof notif
                                            ]
                                                ? "var(--blue)"
                                                : "var(--bg-4)",
                                            position: "relative",
